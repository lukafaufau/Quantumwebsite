    ...
    <footer className="bg-black text-white border-t border-white/20">
      <div className="container mx-auto px-4 py-20 flex flex-col md:flex-row justify-between gap-16 md:gap-0">
        ...
        <div className="flex flex-col items-center md:items-start space-y-5">
          <Link href="/" className="text-4xl font-heading font-bold hover:text-white/80 transition-all">
            Nemesis
          </Link>
        ...
        {/* Navigation */}
        <div className="flex flex-col items-center md:items-start space-y-5">
          <h3 className="font-heading font-semibold text-white text-lg hover:text-white/80 transition-all cursor-default">
            Navigation
          </h3>
